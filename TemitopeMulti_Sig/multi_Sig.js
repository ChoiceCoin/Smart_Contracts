...
// sandbox
const token = "";   // add your algod-token here
const server = "http://localhost";  // add algod-address here (in this case, it's your purestake api)
const port = 4001;  // add algod-port
...
(async() => {
   ...
   // await keypress();
    ...
    //    let algodclient = new algosdk.Algod(token, server, port);
        ...
        let note = algosdk.encodeObj("MultiSig Wallet");
        amount = 200000;
        //  image BUG - 
